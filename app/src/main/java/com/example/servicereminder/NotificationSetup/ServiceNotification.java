...
public class ServiceNotification extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        PendingIntent pendingIntent = PendingIntent.getActivity(context, 0, intentToOpenMain, 0);
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context, ID_FOR_NOTIFICATION_CHANNEL)
